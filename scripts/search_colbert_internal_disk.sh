...
for bs in 100 200 ; do
    ...
    python3 -m src.colbert_embs \
        k=15 \
        embedder.mode="disk" \
        colbert_internal.rerank_internal=False \
        colbert_internal.rerank_external=True \
    ...
    python3 -m src.colbert_embs \
        k=15 \
        colbert_internal.rerank_internal=True \
        colbert_internal.rerank_external=False \
        data.dataset_name=$dataset_name \
        augment=True \
        index=False \
        dbl_norm=True \
