...
for ((i = 0; i < NUM_RH_AUGMENT; i++)); do
    ...
    python3 -m src.colbert_embs data.dataset_name=$DATASET_NAME embedder.mode="disk" overwrite_index=True index=True augment=True dbl_norm=True method="augmented" generate_new_rh=True rh_num=$i &
