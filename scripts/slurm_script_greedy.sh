...
# Run your command
python3 -m src.endtoend k=15 method='v0' embedder.mode="disk" baseline.distributed_search=False baseline.bucket_size=$1 data.dataset_name=$2 embedder.mv_type='colbertv2-plaid' load_state=$3