...
class Searcher:
    ...
    def search_all_modified(self, queries, Q, k=10, filter_fn=None, full_length_search=False, qid_to_pids=None):
        
        if self.checkpoint_config.augment:
            Q  = self.checkpoint._RH_augmentation(Q)
