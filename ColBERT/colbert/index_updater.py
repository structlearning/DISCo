...
class IndexUpdater:
    ...
    def __init__(self, config, searcher, checkpoint=None):
        raise ValueError("Not compatible with our monkeypatch, as we are fetching from disk. comment this out/ modify this accordingly")
        self.config = config
    ...
    def create_embs_and_doclens(
        ...
        # self.encoder.encode_passages_to_dump(
        #     passages, embs_file_prefix
        # )
        # embs, doclens = self.encoder.encode_passages_from_disk(embs_file_prefix)
