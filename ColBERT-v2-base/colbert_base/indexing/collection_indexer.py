...
from colbert_base.infra.config.config import ColBERTConfig

import colbert_base.utils.distributed as distributed
...
from colbert_base.data.collection import Collection

from colbert_base.indexing.collection_encoder import CollectionEncoder
from colbert_base.indexing.index_saver import IndexSaver
from colbert_base.utils.utils import flatten, print_message

from colbert_base.indexing.codecs.residual import ResidualCodec
...
class CollectionIndexer():
    ...
    def _sample_embeddings(self, sampled_pids):
        ...
        local_sample_embs, doclens = self.encoder.encode_passages_modified(local_sample)
