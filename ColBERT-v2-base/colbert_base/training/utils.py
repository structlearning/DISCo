...
from colbert_base.utils.utils import print_message, save_checkpoint
from colbert_base.parameters import SAVED_CHECKPOINTS
...
def manage_checkpoints(args, colbert, optimizer, batch_idx, savepath=None, consumed_all_triples=False):
    ...
    try:
        save = colbert_base.save
    except:
        save = colbert_base.module.save
    ...
    if consumed_all_triples or (batch_idx % 2000 == 0):
        # name = os.path.join(path, "colbert_base.dnn")
