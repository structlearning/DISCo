...
from colbert_base.utils.utils import timestamp
...
@dataclass
class DocSettings:
    lin_dim: int = DefaultVal(128) # output dim of linear layer of the encoder
    dim: int = DefaultVal(128) # actual dim in of what will be indexed :  this will be (lin_dim*2) in our augmented case, 128 otherwise
